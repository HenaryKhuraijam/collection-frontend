...
# 📖Collect <a name="about-project"></a>

> In this project, I build a collect App using HTML, CSS, JavaScript, React.
...
### Key Features <a name="key-features"></a>
  ...
  **[Collection]**
  > It will be able to perform Simple functions to collect data.
